...
import diffusers.models.autoencoders.vae as _vae
FromOriginalModelMixin = getattr(_loaders, "FromOriginalModelMixin", object)
AutoencoderMixin = getattr(_vae, "AutoencoderMixin", object)
